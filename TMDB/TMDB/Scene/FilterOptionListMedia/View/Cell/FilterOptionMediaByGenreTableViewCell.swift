//
//  FilterOptionMediaByGenreTableViewCell.swift
//  TMDB
//
...
class FilterOptionMediaByGenreTableViewCell: UITableViewCell {
    
//    MARK: - Properties
    var viewModel: FilterOptionMediaByGenreCellViewModel! {
        didSet {
...
//    MARK: - Methods
    ...
    fileprivate func configure(with vm: FilterOptionMediaByGenreCellViewModel) {
