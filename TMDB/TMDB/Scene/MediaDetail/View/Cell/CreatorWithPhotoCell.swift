...
class CreatorWithPhotoCell: UITableViewCell {
    
//    MARK: - Properties
    var viewModel: CreatorWithPhotoCellViewModel! {
        didSet {
...
//    MARK: - Methods
    fileprivate func configure(with vm: CreatorWithPhotoCellViewModel) {
