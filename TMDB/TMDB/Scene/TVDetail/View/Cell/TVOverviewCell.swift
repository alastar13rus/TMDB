...
class TVOverviewCell: UITableViewCell {
    
//    MARK: - Properties
    var viewModel: TVOverviewCellViewModel! {
        didSet {
...
//    MARK: - Methods
    fileprivate func configure(with vm: TVOverviewCellViewModel) {
